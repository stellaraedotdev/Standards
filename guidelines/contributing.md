...
## Purpose
Define a clear, low-friction process for proposing, implementing, and shipping changes safely.

## Scope
Applies to all repositories that adopt Stellarae standards, including code, tests, documentation, and configuration changes.
